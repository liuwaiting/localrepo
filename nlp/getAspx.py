...
uri = 'https://pkaihair.mylocalsalon.com/onlinebooking/v7410/Steps/SelectTimes.aspx'
...
formFields = (
   ...
   (r'ctl00$MainContentHolder$StartDateTxt', 'Friday 12/18/2015'), 
   (r'ctl00$MainContentHolder$SelectTimesRepeater$ctl01$Day1Chk', 'on'), 
   (r'ctl00$MainContentHolder$SelectTimesRepeater$ctl01$Day3Chk', 'on'),
   (r'ctl00$MainContentHolder$SelectTimesRepeater$ctl01$StartTimeEntry$TimeCombo', '8'),

   #but then we come to fields of interest: the search
   #criteria the collections to search from etc.
                                                       # Check boxes  
                                                       # etc. (not all listed)
   (r'ctl00$MainContentHolder$SelectTimesRepeater$ctl01$EndTimeEntry$TimeCombo', '19'),   # Search text
   (r'ctl00$MainContentHolder$NextBtn', 'Next')  # Years to include
)
